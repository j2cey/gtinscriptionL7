...
trait HasVideo
{
    ...
    public function setVideoParameters_old(Request $request,$directory, $fieldname_rqst, $filename, $duration_field, $artwork_field) {
    ...
    public function setVideoParameters($directory, $filename, $duration_field, $artwork_field) {
